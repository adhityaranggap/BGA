<div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          @if(Auth::check() && auth()->user()->role_id != App\ROLE::ROLE_SANTRI)
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown {{ Str::startsWith(Request::path(),'users') === true  ? 'active' : ''}}">
                ...
                <ul class="dropdown-menu">
                  <li class="{{ Str::startsWith(Request::path(),'users/customers') ? 'active' : ''}}"><a class="nav-link" href="{{ route('santri-index') }}">Santri</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="{{ route('santri-subscription-index') }}">Santri Subsc</a></li>
