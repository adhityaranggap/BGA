...
class SantriSubscriptionController extends Controller
{
    /**
    ...
    {
        return view('cms.subscription.santrisubscription.index');
    }
    ...
    {       
        ...
        ->editColumn('action',
            function ($data){                                
                    ...
                    \Component::btnUpdate(route('santri-subscription-edit', $data->id), 'Ubah subscription '. $data->nis).
                    \Component::btnDelete(route('santri-subscription-destroy', $data->id), 'Hapus subscription '. $data->subscription_name);
    ...
    public function loadData(Request $request)
    {
        if ($request->has('q')) {
            ...
            $data = DB::table('users')
            ->select('id', 'nis', 'name')
            ->where('users.name', 'like', '%' . $cari . '%')->get();
    ...
    public function create()
    {
        ...
        return view('cms.subscription.santrisubscription.create', compact ('subscriptions'));
        // $arrSelect = [
        //     'users.nis as nis',
        //     'user_has_subscription.id as id',
        //     'subscriptions.name as subscription_name',
        ...
        // return view('cms.subscription.santrisubscription.edit', compact ('data','subscriptions'));
