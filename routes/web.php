...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('users')->group(function () {
        ...
        Route::prefix('santri')->group(function () {
            Route::get('/', 'Web\SantriController@index')->name('santri-index');//done
            ...
            Route::get('/load', 'Web\SantriController@loadData')->name('santri-load');//done
            Route::get('/edit/{id}', 'Web\SantriController@edit')->name('santri-edit');//done
            Route::post('/update/{id}', 'Web\SantriController@update')->name('santri-update');//done
            Route::delete('/destroy/{id}', 'Web\SantriController@destroy')->name('santri-destroy'); //done
        });
    ...
    Route::prefix('subscription')->group(function () {
        ...
        Route::prefix('santri-subscription-index')->group(function () {
            Route::get('/', 'Web\SantriSubscriptionController@index')->name('santri-subscription-index');//done
            Route::get('/datatables', 'Web\SantriSubscriptionController@datatables')->name('santri-subscription-datatables');//done
            Route::get('/create', 'Web\SantriSubscriptionController@create')->name('santri-subscription-create');//done
            Route::get('/load', 'Web\SantriSubscriptionController@loadData')->name('santri-subscription-load');//done

            Route::post('/store', 'Web\SantriSubscriptionController@store')->name('santri-subscription-store');//done
            Route::get('/edit/{id}', 'Web\SantriSubscriptionController@edit')->name('santri-subscription-edit');//done
            
            Route::post('/update/{id}', 'Web\SantriSubscriptionController@update')->name('santri-subscription-update');//done
            Route::delete('/destroy/{id}', 'Web\SantriSubscriptionController@destroy')->name('santri-subscription-destroy');  //only admin
        });
